...
namespace InhospitalIndicators.Service.Services.CurrentPeriod
{
    ...
    class InItem : BaseManager<FeeItem>
    {
        ...
        {
            return Db.SqlQueryable<FeeItem>($@"select sum(amt1) fee,a.nu,c.codename  Project,sugbe,'同期' age from twipd_slip a, twbas_tsuga b,twbas_basecode c  where a.nu<>90
                ...
                union
                select sum(amt1) fee,a.nu,c.codename  Project,sugbe,'当期' age from twipd_slip a, twbas_tsuga b,twbas_basecode c  where a.nu<>90
